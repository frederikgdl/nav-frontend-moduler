# less-module: nav-frontend-internheader-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-internheader-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-internheader-style
<!-- AUTO-GENERATED-CONTENT:END *-->