# react-module: nav-frontend-internheader

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-internheader react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-internheader
<!-- AUTO-GENERATED-CONTENT:END *-->